                ...
                <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm ring-1 ring-slate-900/5 sm:p-8">
                    ...
                    @if ($document->file_path)
                        <div class="mt-6 rounded-xl border border-slate-100 bg-slate-50 p-4">
                            ...
                            <a href="{{ asset('storage/'.$document->file_path) }}" class="mt-2 inline-flex text-sm font-semibold text-teal-700 hover:text-teal-800" target="_blank" rel="noopener">{{ basename($document->file_path) }}</a>
                        </div>
                    @endif
                </section>
